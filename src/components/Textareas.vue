<script>
import count from "../scripts/count.js"
...
<template>
    <textarea id="title" v-on:keyup="count" v-on:keydown="count" placeholder="Title" autocomplete="off"></textarea>
    <h1 id="titlechar">0</h1>
    <textarea id="text" v-on:keyup="count" v-on:keydown="count" placeholder="Content" autocomplete="off"></textarea>
    <h1 id="textchar">0</h1>
